...
const Home = {
  async render() {
    return `
      ...
      <div class="shadow-lg p-3 mb-5 bg-body rounded d-flex justify-content-center align-items-center mt-5" style="min-height: 350px; width: 100%">
      <h4>More you know about Growth Familie</h4>
      <div class="d-flex justify-content-center align-items-center">
        <a href="#/about" class="btn ms-3 rounded-pill">About page</a>
      </div>
      </div>
    `;
  },
